...
"resource": {
  ...
  "rules":[
    ...
    [["if",12,13],["add",6]],
    [["if",14,15],["add",7]],
    [["if",16,17],["add",8,27,30]],
    [["if",17],["add",9,10,24,28,33,34,12,13,14,15,16,17,18]],
    [["if",18,19],["add",11]],
    [["if",3,20],["add",19]],
    [["if",3,21],["add",20]],
    [["if",3,22],["add",21]],
...
var Hc,Ic=function(){};(function(){function a(k,l){k=k||"";l=l||{};for(var p in b)b.hasOwnProperty(p)&&(l.Vg&&(l["fix_"+p]=!0),l.nf=l.nf||l["fix_"+p]);var q={comment:/^\x3c!--/,endTag:/^<\//,atomicTag:/^<\s*(script|style|noscript|iframe|textarea)[\s\/>]/i,startTag:/^</,chars:/^[^<]/},n={comment:function(){var r=k.indexOf("--\x3e");if(0<=r)return{content:k.substr(4,r),length:r+3}},endTag:function(){var r=k.match(d);if(r)return{tagName:r[1],length:r[0].length}},atomicTag:function(){var r=n.startTag();
if(r){var t=k.slice(r.length);if(t.match(new RegExp("</\\s*"+r.tagName+"\\s*>","i"))){var v=t.match(new RegExp("([\\s\\S]*?)</\\s*"+r.tagName+"\\s*>","i"));if(v)return{tagName:r.tagName,aa:r.aa,content:v[1],length:v[0].length+r.length}}}},startTag:function(){var r=k.match(c);if(r){var t={};r[2].replace(e,function(v,w,z,x,A){var y=z||x||A||f.test(w)&&w||null,B=document.createElement("div");B.innerHTML=y;t[w]=B.textContent||B.innerText||y});return{tagName:r[1],aa:t,Nc:!!r[3],length:r[0].length}}},chars:function(){var r=
k.indexOf("<");return{length:0<=r?r:k.length}}},u=function(){for(var r in q)if(q[r].test(k)){var t=n[r]();return t?(t.type=t.type||r,t.text=k.substr(0,t.length),k=k.slice(t.length),t):null}};l.nf&&function(){var r=/^(AREA|BASE|BASEFONT|BR|COL|FRAME|HR|IMG|INPUT|ISINDEX|LINK|META|PARAM|EMBED)$/i,t=/^(COLGROUP|DD|DT|LI|OPTIONS|P|TD|TFOOT|TH|THEAD|TR)$/i,v=[];v.tf=function(){return this[this.length-1]};v.Dd=function(B){var D=this.tf();return D&&D.tagName&&D.tagName.toUpperCase()===B.toUpperCase()};v.gh=
function(B){for(var D=0,E;E=this[D];D++)if(E.tagName===B)return!0;return!1};var w=function(B){B&&"startTag"===B.type&&(B.Nc=r.test(B.tagName)||B.Nc);return B},z=u,x=function(){k="</"+v.pop().tagName+">"+k},A={startTag:function(B){var D=B.tagName;"TR"===D.toUpperCase()&&v.Dd("TABLE")?(k="<TBODY>"+k,y()):l.Hi&&t.test(D)&&v.gh(D)?v.Dd(D)?x():(k="</"+B.tagName+">"+k,y()):B.Nc||v.push(B)},endTag:function(B){v.tf()?l.sh&&!v.Dd(B.tagName)?x():v.pop():l.sh&&(z(),y())}},y=function(){var B=k,D=w(z());k=B;if(D&&
A[D.type])A[D.type](D)};u=function(){y();return w(z())}}();return{append:function(r){k+=r},ai:u,Mi:function(r){for(var t;(t=u())&&(!r[t.type]||!1!==r[t.type](t)););},clear:function(){var r=k;k="";return r},Ni:function(){return k},stack:[]}}var b=function(){var k={},l=this.document.createElement("div");l.innerHTML="<P><I></P></I>";k.Si="<P><I></P></I>"!==l.innerHTML;l.innerHTML="<P><i><P></P></i></P>";k.Qi=2===l.childNodes.length;return k}(),c=/^<([\-A-Za-z0-9_]+)((?:\s+[\w\-]+(?:\s*=?\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
d=/^<\/([\-A-Za-z0-9_]+)[^>]*>/,e=/([\-A-Za-z0-9_]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|([^>\s]+)))?/g,f=/^(checked|compact|declare|defer|disabled|ismap|multiple|nohref|noresize|noshade|nowrap|readonly|selected)$/i;a.supports=b;for(var h in b);Hc=a})();(function(){function a(){}function b(n){return void 0!==n&&null!==n}function c(n,u,r){var t,v=n&&n.length||0;for(t=0;t<v;t++)u.call(r,n[t],t)}function d(n,u,r){for(var t in n)n.hasOwnProperty(t)&&u.call(r,t,n[t])}function e(n,u){d(u,
function(r,t){n[r]=t});return n}function f(n,u){n=n||{};d(u,function(r,t){b(n[r])||(n[r]=t)});return n}function h(n){try{return p.call(n)}catch(r){var u=[];c(n,function(t){u.push(t)});return u}}var k={Og:a,Pg:a,Qg:a,Rg:a,Wg:a,Xg:function(n){return n},done:a,error:function(n){throw n;},di:!1},l=this;if(!l.postscribe){var p=Array.prototype.slice,q=function(){function n(r,t,v){var w="data-ps-"+t;if(2===arguments.length){var z=r.getAttribute(w);return b(z)?String(z):z}b(v)&&""!==v?r.setAttribute(w,v):
r.removeAttribute(w)}function u(r,t){var v=r.ownerDocument;e(this,{root:r,options:t,Tb:v.defaultView||v.parentWindow,hb:v,Dc:Hc("",{Vg:!0}),pd:[r],Nd:"",Od:v.createElement(r.nodeName),Qb:[],Sa:[]});n(this.Od,"proxyof",0)}u.prototype.write=function(){[].push.apply(this.Sa,arguments);for(var r;!this.vc&&this.Sa.length;)r=this.Sa.shift(),"function"===typeof r?this.bh(r):this.Xd(r)};u.prototype.bh=function(r){var t={type:"function",value:r.name||r.toString()};this.Id(t);r.call(this.Tb,this.hb);this.vf(t)};
u.prototype.Xd=function(r){this.Dc.append(r);for(var t,v=[],w,z;(t=this.Dc.ai())&&!(w=t&&"tagName"in t?!!~t.tagName.toLowerCase().indexOf("script"):!1)&&!(z=t&&"tagName"in t?!!~t.tagName.toLowerCase().indexOf("style"):!1);)v.push(t);this.ri(v);w&&this.zh(t);z&&this.Ah(t)};u.prototype.ri=function(r){var t=this.Zg(r);t.af&&(t.zd=this.Nd+t.af,this.Nd+=t.Zh,this.Od.innerHTML=t.zd,this.ni())};u.prototype.Zg=function(r){var t=this.pd.length,v=[],w=[],z=[];c(r,function(x){v.push(x.text);if(x.aa){if(!/^noscript$/i.test(x.tagName)){var A=
t++;w.push(x.text.replace(/(\/?>)/," data-ps-id="+A+" $1"));"ps-script"!==x.aa.id&&"ps-style"!==x.aa.id&&z.push("atomicTag"===x.type?"":"<"+x.tagName+" data-ps-proxyof="+A+(x.Nc?" />":">"))}}else w.push(x.text),z.push("endTag"===x.type?x.text:"")});return{Ti:r,raw:v.join(""),af:w.join(""),Zh:z.join("")}};u.prototype.ni=function(){for(var r,t=[this.Od];b(r=t.shift());){var v=1===r.nodeType;if(!v||!n(r,"proxyof")){v&&(this.pd[n(r,"id")]=r,n(r,"id",null));var w=r.parentNode&&n(r.parentNode,"proxyof");
w&&this.pd[w].appendChild(r)}t.unshift.apply(t,h(r.childNodes))}};u.prototype.zh=function(r){var t=this.Dc.clear();t&&this.Sa.unshift(t);r.src=r.aa.src||r.aa.Ai;r.src&&this.Qb.length?this.vc=r:this.Id(r);var v=this;this.oi(r,function(){v.vf(r)})};u.prototype.Ah=function(r){var t=this.Dc.clear();t&&this.Sa.unshift(t);r.type=r.aa.type||r.aa.TYPE||"text/css";this.si(r);t&&this.write()};u.prototype.si=function(r){var t=this.ah(r);this.Dh(t);r.content&&(t.styleSheet&&!t.sheet?t.styleSheet.cssText=r.content:
t.appendChild(this.hb.createTextNode(r.content)))};u.prototype.ah=function(r){var t=this.hb.createElement(r.tagName);t.setAttribute("type",r.type);d(r.aa,function(v,w){t.setAttribute(v,w)});return t};u.prototype.Dh=function(r){this.Xd('<span id="ps-style"/>');var t=this.hb.getElementById("ps-style");t.parentNode.replaceChild(r,t)};u.prototype.Id=function(r){r.Sh=this.Sa;this.Sa=[];this.Qb.unshift(r)};u.prototype.vf=function(r){r!==this.Qb[0]?this.options.error({message:"Bad script nesting or script finished twice"}):
(this.Qb.shift(),this.write.apply(this,r.Sh),!this.Qb.length&&this.vc&&(this.Id(this.vc),this.vc=null))};u.prototype.oi=function(r,t){var v=this.$g(r),w=this.ii(v),z=this.options.Og;r.src&&(v.src=r.src,this.gi(v,w?z:function(){t();z()}));try{this.Ch(v),r.src&&!w||t()}catch(x){this.options.error(x),t()}};u.prototype.$g=function(r){var t=this.hb.createElement(r.tagName);d(r.aa,function(v,w){t.setAttribute(v,w)});r.content&&(t.text=r.content);return t};u.prototype.Ch=function(r){this.Xd('<span id="ps-script"/>');
var t=this.hb.getElementById("ps-script");t.parentNode.replaceChild(r,t)};u.prototype.gi=function(r,t){function v(){r=r.onload=r.onreadystatechange=r.onerror=null}var w=this.options.error;e(r,{onload:function(){v();t()},onreadystatechange:function(){/^(loaded|complete)$/.test(r.readyState)&&(v(),t())},onerror:function(){var z={message:"remote script failed "+r.src};v();w(z);t()}})};u.prototype.ii=function(r){return!/^script$/i.test(r.nodeName)||!!(this.options.di&&r.src&&r.hasAttribute("async"))};
return u}();l.postscribe=function(){function n(){var w=t.shift(),z;w&&(z=w[w.length-1],z.Pg(),w.stream=u.apply(null,w),z.Qg())}function u(w,z,x){function A(E){E=x.Xg(E);v.write(E);x.Rg(E)}v=new q(w,x);v.id=r++;v.name=x.name||v.id;var y=w.ownerDocument,B={close:y.close,open:y.open,write:y.write,writeln:y.writeln};e(y,{close:a,open:a,write:function(){return A(h(arguments).join(""))},writeln:function(){return A(h(arguments).join("")+"\n")}});var D=v.Tb.onerror||a;v.Tb.onerror=function(E,I,M){x.error({msg:E+
" - "+I+":"+M});D.apply(v.Tb,arguments)};v.write(z,function(){e(y,B);v.Tb.onerror=D;x.done();v=null;n()});return v}var r=0,t=[],v=null;return e(function(w,z,x){"function"===typeof x&&(x={done:x});x=f(x,k);w=/^#/.test(w)?l.document.getElementById(w.substr(1)):w.Ji?w[0]:w;var A=[w,z,x];w.Vh={cancel:function(){A.stream?A.stream.abort():A[1]=a}};x.Wg(A);t.push(A);v||n();return w.Vh},{streams:{},Li:t,Ci:q})}();Ic=l.postscribe}})();var C={Ab:"_ee",nd:"_syn",Bi:"_uei",gd:"_eu",zi:"_pci",Vc:"event_callback",$b:"event_timeout",fa:"gtag.config",Ja:"gtag.get",la:"purchase",Ya:"refund",Ia:"begin_checkout",Wa:"add_to_cart",Xa:"remove_from_cart",Wf:"view_cart",ie:"add_to_wishlist",xa:"view_item",he:"view_promotion",fe:"select_promotion",Qc:"select_item",Xb:"view_item_list",ee:"add_payment_info",Vf:"add_shipping_info",Aa:"value_key",za:"value_callback",ia:"allow_ad_personalization_signals",cd:"restricted_data_processing",qb:"allow_google_signals",
...
a.vtp_userId);var p=Wj();(l.google_additional_params=l.google_additional_params||{}).gdpr_consent=p;h(l)||c()}else c()},e=function(){P(b,d,c)},f=!1;Fd()&&!f?Qd(function(){Od(C.B)?e():Jd(e,C.B)},[C.B]):(Zh(),e())})}();Z.g.c=["google"],function(){(function(a){Z.__c=a;Z.__c.h="c";Z.__c.i=!0;Z.__c.priorityOverride=0})(function(a){en(a.vtp_value,"c",a.vtp_gtmEventId);return a.vtp_value})}();
...
Qh()}ld(G,"load",Ph)}Cl=!1;"complete"===H.readyState?El():ld(G,"load",El);a:{if(!Ii)break a;G.setInterval(Ji,864E5);}var z=L;z.postscribe||(z.postscribe=G.postscribe||Ic);Re=(new Date).getTime();}}
